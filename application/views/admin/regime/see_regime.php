              ...
              <div class="row d-flex">
                <div class="card my-3 col-lg-5">
                    <div class="my-3 row p-3">
                      ...
                      <div class="col-lg-5">
                        <input type="text" value="<?php echo $regime['nom']; ?>" class="form-control" disabled name="nom" id="">
                      </div>
                    </div>
                    <div class="my-3 row p-3">
                      <div class="col-lg-5">
                      ...
                      <div class="col-lg-5">
                        <input type="text" class="form-control disabled" value="<?php echo $regime['apport']; ?>" disabled name="apports" id="">
                      </div>
                    </div>
                </div>
