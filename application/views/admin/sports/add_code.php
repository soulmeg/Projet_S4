            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold"> Ajouter une activité </h3>
                </div>
              </div>
              <div class="row">
                
                <div class="card my-3">
                  <form action="<?php echo site_url('admin/admin/insert_sport'); ?>" method="POST" class="form">
                    ...
                    <div class="my-3 row p-3">
                      ...
                      <div class="col-lg-5">
                        <input class="form-control" type="text" name="perte" id="">
                      </div>
                    </div>
